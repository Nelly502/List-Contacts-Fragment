...
class ListFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        items = arrayListOf()
        items.add(Information("01", "Pham Phuong Nga", "0987654321", "pinatsu225@gmail.com"))
        items.add(Information("02", "Tran Thu Huyen", "0123456789", "huyen2404@gmail.com"))
        items.add(Information("03", "Vu Anh Tuan", "0567891234", "tuan1407@gmail.com"))
        items.add(Information("04", "Tran Duc Canh", "0432198765", "canh2701@gmail.com"))
        for(it in 5..16) {
            items.add(Information("0$it", "Anonymous", "0987654321", "pinatsu225@gmail.com"))
        }
